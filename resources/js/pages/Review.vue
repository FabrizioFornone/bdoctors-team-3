    ...
    <div class="container">
        ...
        <div v-if="!formSubmitted">
            ...
            <div class="mb-3">
                ...
                <span class="text-danger" v-if="formValidationErrors && formValidationErrors.text">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlTextarea1" v-model="formData.vote">
                <span class="text-danger" v-if="formValidationErrors && formValidationErrors.vote">
